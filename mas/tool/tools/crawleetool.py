...
class CrawleeTool(Toolkit):
    ...
    def crawl_content(start_url: str, titles: bool = True, paragraphs: bool = False, 
        ...
        """
        return json.dumps(asyncio.run(CrawleeTool.crawl_content_async(start_url, titles, paragraphs, code, tables, max_requests, headless)))[0:10000]
